...
# rm(fileout)
# 
# filesrc <- paste(datadir, "StormData.csv.bz2", "/")
# filesrc <- bzfile(filesrc, open = "r")
# StormData <- data.table(read.csv(filesrc, skip = 1))
# flush(filesrc)
# close(filesrc)
...
mtext("Aggregate Frequency of Events Observed across The USA (1950 ~ 2011)", 
      side = 1, line = -2, adj = 1, cex = 0.65)
