...
```
  ...
  Figure 1 above consists of 4 barcharts, each illustrating different dimensions of the data but correlated weather events in the USA. Related weather events are grouped together for this reporting purpose, e.g. all wind related events such as high wind, storm, thunderstorm, gustnado ect are grouped under **WIND.STORM** type. **RAIN.FLOOD** type consists of all water related events such as heavy rains and floods or events that lead to flooding.
...
```
  ...
  For the same period, scatter plot for Property/Crop Loss and scatter plot for Number of Casualty at the bottom of figure 3 yield an interesting situation where Economic Loss is rising while Number of Casualty is declining, as oppose to the general consensus of rising trend.  
&nbsp;
