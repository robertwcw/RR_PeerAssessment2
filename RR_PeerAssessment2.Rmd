...
# aggregate weather events by class across the USA.
evcnt <- stormsub %>%
...
mtext("Weather Events Frequency Aggregate by Class Across USA (1950 ~ 2011)", font = 2, side = 3, line = -1.25, adj = 1, cex = 0.70)
...
# aggregate weather events manifested in casualty and economic loss by class across the USA.
evcnt <- stormsub %>%
        select(STATE,EVCLASS,EVTYPE,FATALITIES,INJURIES,PROPDMG,CROPDMG) %>%
...
# plotting barchart for weather events manifested in casualty and economic loss aggregate by class across the USA.
par(mai = c(0.50,0.15,0.50,1.15), yaxt = "n")
barplot(evcnt$n, horiz = TRUE, border = NA, col = pal, names.arg = unique(evcnt$EVCLASS))
mtext("Weather Events Manifested in Casualty & Economic Loss", font = 2, side = 3, line = -1.25, adj = 1, cex = 0.70)
mtext("Frequency Aggregate by Class Across USA (1950 ~ 2011)", font = 2, side = 3, line = -2.00, adj = 1, cex = 0.70)
...
barplot(n ~ EVCLASS + as.character(STATE), data = evcnt, 
        ...
        border = NA,
        col = pal)
title(ylab = "Events Frequency Aggregate by Class")
mtext("Weather Events of Individual-State by Class", font = 2, side = 3, line = -1.25, adj = 0, padj = 0, cex = 0.70)
...
barplot(n ~ EVCLASS + as.character(STATE), data = evcnt, 
        ...
        col = pal)
title(ylab = "Events Frequency Aggregate by Class")
mtext("Weather Events Manifested in Casualty & Economic Loss", font = 2, side = 3, line = -1.25, adj = 0, padj = 0, cex = 0.70)
mtext("of Individual-State by Class (1950 ~ 2011)", font = 2, side = 3, line = -2.00, adj = 0, padj = 0, cex = 0.70)
