...
points(x = ev.w.gcs$LONGITUDE, y = ev.w.gcs$LATITUDE, pch = 20, cex = 1.0, 
...
points(x = ev.w.gcs$LONGITUDE, y = ev.w.gcs$LATITUDE, pch = 20, cex = 0.8, 
       col = alpha(pal[ev.klass], 0.5))

plot(4, type = "n",axes = FALSE, ann = FALSE)
legend("center", c(1,1), ev.class[ev.klass,2], fill = pal[ev.klass], border = pal[ev.klass], bty = "n", x.intersp = 1, y.intersp = 1.5)
