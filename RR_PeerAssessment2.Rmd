...
Loading *raw* storm data set in comma-delimited text file downloaded from Coursera course website into R workspace as data.table class object with naming derive from the data source programmatically, by-passing manual data staging process.
...
A *raw* data set named **`r print(filenam)`** data object was extracted from NOAA's sourced data downloaded from the course website.
