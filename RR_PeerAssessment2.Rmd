...
# # NOT USED
# # strip -ve sign from -ve numeric values found in LATITUDE & LONGITUDE vectors 
#   StormData$LATITUDE <- sapply(StormData$LATITUDE, udf.stripsign)
#   StormData$LONGITUDE <- sapply(StormData$LONGITUDE, udf.stripsign)

# prepend -ve sign to +ve numeric values of the LATITUDE & LONGITUDE vectors
StormData$LATITUDE <- sapply(StormData$LATITUDE, udf.prependsign)
StormData$LONGITUDE <- sapply(StormData$LONGITUDE, udf.prependsign)

# reformat LATITUDE & LONGITUDE vectors to proper geographic coordinate system format nnn.ddd
  StormData$LATITUDE <- sapply(StormData$LATITUDE, udf.num2gcs, 3)
  StormData$LONGITUDE <- sapply(StormData$LONGITUDE, udf.num2gcs, 3)
