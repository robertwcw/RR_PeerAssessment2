...
par(mai = c(0.75,1.15,0.50,0.15), las = 1, cex.axis = 0.65)
...
for (i in 1:length(m)) {
        ifelse(evcnt$n[i] >= maxtik, v <- -2.0, v <- 0.25)
        text(evcnt$n[i], m[i], labels = formatC(evcnt$n[i], big.mark = ","), pos = 4,  offset = v, cex = 0.60)
}
# mtext("Weather Events Aggregate Across The USA (1950 ~ 2011)", cex = 1.00)
# mtext("Weather Events Aggregate in USA (1950 ~ 2011)", side = 1, line = -2, adj = 1, cex = 0.75)
...
par(mai = c(0.75,0.15,0.50,1.15), yaxt = "n", las = 1, cex.axis = 0.65)
barplot(evcnt$n, horiz = TRUE, border = NA, col = pal, names.arg = unique(evcnt$EVCLASS))
...
# mtext("Aggregate of Weather Events Manifested in Casualty & Economic Loss", side = 1, line = -2, adj = 1, cex = 0.80)
# mtext("(US Affiliated Territories Not Included)", side = 1, line = -1.25, adj = 1, cex = 0.70)
...
par(mai = c(1.00,1.15,0.25,0.15), cex.axis = 0.60, cex.lab = 0.70, ann = TRUE)
barplot(n ~ EVCLASS + as.character(STATE), data = evcnt, 
        horiz = FALSE, 
        border = NA,
        col = pal,
        ylab = "Weather Events Frequency of Individual-State")
...
par(mai = c(1.00,0.50,0.25,0.50), cex.axis = 0.60, cex.lab = 0.70, ann = FALSE)
barplot(n ~ EVCLASS + as.character(STATE), data = evcnt, 
        horiz = FALSE, 
        border = NA,
        col = pal)
