...
mtext("(US Affiliated Territories Not Included)", side = 3, line = -1.00, adj = 1, cex = 0.65)
...
mtext("Weather Event Frequency Aggregate Across USA (1950 ~ 2011)", font = 2, side = 3, line = 0.25, adj = 1, cex = 0.75)
mtext("Manifested in Casualty & Property/Crop Loss", font = 2, side = 3, line = -1.00, adj = 1, cex = 0.75)
mtext("(US Affiliated Territories Not Included)", side = 3, line = -2.25, adj = 1, cex = 0.65)
maxtik <- max(axTicks(1))
