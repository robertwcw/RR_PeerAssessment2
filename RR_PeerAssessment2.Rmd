...
Loading *raw* storm data in comma-delimited text file into R workspace from Coursera course website, by-passing unnecessary intermediate manual processes, stored as data.table class object for memory efficiency. 
...
One *raw* data set named **StormData** object was extracted from the NOAA's sourced data downloaded from the course website. 
