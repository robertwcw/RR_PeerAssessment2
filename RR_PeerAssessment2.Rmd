...
par(mai = c(0.25, 1.10, 0.25, 1.10), las = 1, cex.axis = 0.75, ann = FALSE, yaxt = "s")

barplot(CASULTIE ~ EVCLASS + as.character(STATE), data = evcnt3,
        border = NA,
        col = pal)
title(ylab = "Casualty Count ( '000 )", cex.lab = 0.90)
mtext("Casualty by Event Type of Individual-State (1950 ~ 2011)", font = 2, side = 3, line = -0.75, adj = 0, padj = 0, cex = 0.80)

barplot(ECONLOSS ~ EVCLASS + STATE, data = evcnt3,
        border = NA,
        col = pal)
title(ylab = "Property/Crop Loss ( $Bn )", cex.lab = 0.90)
mtext("Property/Crop Loss by Event Type of Individual-State (1950 ~ 2011)", font = 2, side = 3, line = -0.75, adj = 1, padj = 0, cex = 0.80)
```
